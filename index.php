...
$hakkimda=file_get_contents('./db/'.session('username').'.txt');
...
<div class="container d-flex align-items-center justify-content-center">
    <div class="card <?= cook('color')?cook('color'):'bg-dark';  ?>" style="width: 18rem;">
        ...
        <div class="card-body">
            ...
            <h6 class="card-subtitle mb-2 text-muted"><?= session('email') ?></h6>
            ...
            <form action="islem.php?islem=hakkimda" method="post">
                <textarea class="form-control <?= cook('color')?cook('color'):'bg-dark';  ?> text-primary" name="hakkimda" id="" cols="30" rows="10"><?= $hakkimda  ?>  </textarea>
                <button class="btn btn-sm btn-primary" type="submit">Kaydet</button>
            </form>
            <a href="islem.php?islem=çıkış" class="btn btn-success btn-sm mt-2 w-100">Oturumu Kapat</a><br>
